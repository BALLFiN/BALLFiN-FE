...
export default function ChatHeader({
  ...
  return (
    <div className="flex items-center justify-between p-2 sm:p-5 bg-white/95 backdrop-blur-xl border-b border-gray-100">
      <h3 className="text-lg sm:text-xl font-semibold text-[#0A5C2B]">
        BALLFiN 챗봇
      </h3>
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={onClose}
          className="text-gray-500 hover:text-gray-700 transition-colors p-2 rounded-xl hover:bg-gray-100 relative group"
          title="채팅창 닫기"
        >
